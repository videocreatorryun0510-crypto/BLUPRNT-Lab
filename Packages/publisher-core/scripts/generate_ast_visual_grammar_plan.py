"""Generate the Phase 3.3 AST Visual Grammar plan for product-owner review."""
...
OUTPUT_PATH = REPOSITORY_ROOT / "output" / "plans" / "ast_visual_grammar_v1.plan.json"
...
def main() -> None:
    ...
    plan = PublisherPlanner(registry).build_plan(
        source,
        PublicationRequest(
            request_id="request.ast_visual_grammar_v1_review",
    ...
    print(f"Visual Grammar Publication Plan: {OUTPUT_PATH}")
