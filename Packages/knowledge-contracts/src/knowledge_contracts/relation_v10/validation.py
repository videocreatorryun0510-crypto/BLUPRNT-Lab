"""Schema and validation helpers for Knowledge Relation Version 1.0."""
...
def knowledge_relation_json_schema() -> dict[str, Any]:
    ...
    schema["$id"] = "https://bluprnt-lab.local/schemas/knowledge-relation/1.0"
    schema["title"] = "BLUPRNT Lab Knowledge Relation Version 1.0"
    return schema
