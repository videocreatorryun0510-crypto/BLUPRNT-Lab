"""Schema and validation helpers for Knowledge Relation Version 1.2."""
...
def knowledge_relation_json_schema() -> dict[str, Any]:
    ...
    schema["$id"] = "https://bluprnt-lab.local/schemas/knowledge-relation/1.2"
    schema["title"] = "BLUPRNT Lab Knowledge Relation Version 1.2"
    return schema
