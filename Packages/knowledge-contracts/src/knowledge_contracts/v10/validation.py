"""Draft 2020-12 validation for Knowledge JSON Version 1.0."""
...
from knowledge_contracts.v10.models import KnowledgeRecord
...
def knowledge_record_json_schema() -> dict[str, Any]:
    ...
    schema["$id"] = "https://bluprnt-lab.local/schemas/knowledge-record/1.0"
    schema["title"] = "BLUPRNT Lab Knowledge JSON Version 1.0"
    return schema
