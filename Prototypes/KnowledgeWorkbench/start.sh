...
export PYTHONPATH="$REPOSITORY_DIR/Publishers/PresentationArtifact/src:$REPOSITORY_DIR/Publishers/PresentationEngineAdapter/src:$REPOSITORY_DIR/Publishers/PresentationPromptBuilder/src:$REPOSITORY_DIR/Publishers/ProviderPayloadResolver/src:$REPOSITORY_DIR/Publishers/PresentationRequestBuilder/src:$REPOSITORY_DIR/Publishers/SourceBundlePublisher/src${PYTHONPATH:+:$PYTHONPATH}"
